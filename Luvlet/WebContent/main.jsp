...
<body>
	...
	var itemArray = ['머리가 아프다', '신경이 예민하고 마음의 안정이 안 된다', '쓸데없는 생각이 머리에서 떠나지 않는다', '어지럽거나 현기증이 난다', 
	                ...
	                ,'사소한 일에도 짜증이 난다', '가슴이나 심장이 아프다 ', '넓은 장소나 거리에 가면 두렵다', '기운이 없고 침체된 기분이다', '죽고 싶은 생각이 든다', '다른 사람은 듣지 못하는 헛소리가 들린다', '몸이나 마음이 떨린다', '사람들이란 믿을 것이 못 된다는 생각이 든다', '입맛이 없다', '울기를 잘 한다', '이성을 대하면 어색하거나 부끄럽다', '어떤 함정에 빠져 헤어날 수 없는 기분이 든다', '별 이유 없이 깜짝 놀란다', '자신도 걷잡을 수 없이 울화가 터진다', '혼자서 집을 나서기가 두렵다', '자책을 잘 한다'
	                ,'허리가 아프다', '하고자 하는 일이 뜻대로 안되고 막히는 기분이다', '외롭다', '기분이 울컥하다', '매사에 걱정이 많다', '매사에 관심과 흥미가 없다', '두려운 느낌이 든다', '쉽게 기분이 상한다', '나의 사사로운 생각을 남이 아는 것 같다', '다른 사람들이 나를 이해 못하는 것 같다', '다른 사람들이 나를 싫어하거나 나에게 불친절하다고 느낀다', '매사에 정확을 기하느라고 일을 제때에 해내지 못한다', '심장(가슴)이 마구 뛴다', '구역질이 나거나 게운다', '내가 남보다 못한 것 같다(열등감을 느낀다)', '근육통 또는 신경통이 있다', '다른 사람들이 나를 감시하거나 나에 관해서 쑥덕거리는 것 같다', '잠들기가 어렵다', '매사를 확인하고 또 확인해야만 마음이 놓인다'
	                ,'결단력이 부족하다','자동차나 기차를 타기가 두렵다', '숨쉬기가 거북하다', '목이 화끈거리거나 찰 때(냉할 때)가 있다', '어떤 물건이나 장소 혹은 행위가 겁나서 피해야 했다', '마음속이 텅 빈 것 같다', '몸의 일부가 저리거나 찌릿찌릿하다', '목에 무슨 덩어리가 걸린 것 같다', '장래가 희망이 없는 것 같다', '주의 집중이 잘 안 되는 것 같다', '몸의 어느 부위가 힘이 없다', '긴장이 된다', '팔다리가 묵직하다'
